...
sc create XeerediDPI binPath= "\"%CD%\tools\winws.exe\" --wf-tcp=80,443 --wf-udp=443,50000-50100 --filter-udp=443 --hostlist=\"%CD%\bin\hostlist.txt\" --dpi-desync=fake --dpi-desync-repeats=8 --dpi-desync-fake-quic=\"%CD%\bin\quic_initial_www_google_com.bin\" --new --filter-udp=50000-50100 --filter-l7=discord,stun --dpi-desync=fake --dpi-desync-repeats=6 --new --filter-tcp=80 --hostlist=\"%CD%\bin\hostlist.txt\" --dpi-desync=fake,split2 --dpi-desync-autottl=3 --dpi-desync-fooling=md5sig --new --filter-tcp=443 --hostlist=\"%CD%\bin\hostlist.txt\" --dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --new --filter-udp=443 --ipset=\"%CD%\bin\ipset-cloudflare.txt\" --dpi-desync=fake --dpi-desync-repeats=8 --dpi-desync-fake-quic=\"%CD%\bin\quic_initial_www_google_com.bin\" --new --filter-tcp=80 --ipset=\"%CD%\bin\ipset-cloudflare.txt\" --dpi-desync=fake,split2 --dpi-desync-autottl=3 --dpi-desync-fooling=md5sig --new --filter-tcp=443 --ipset=\"%CD%\bin\ipset-cloudflare.txt\" --dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap" start= auto displayname= "XeerediDPI"
